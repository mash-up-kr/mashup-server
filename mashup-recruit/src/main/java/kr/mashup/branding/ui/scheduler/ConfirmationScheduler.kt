...
class ConfirmationScheduler(
    private val confirmationFacadeService: ConfirmationFacadeService
) {
    ...
    fun updateConfirmationAtRecruitmentEnded() {
        log.info("updateConfirmationAtRecruitmentEnded >>> start")
        confirmationFacadeService.updateToBeDeterminedToNotApplicable(12)
        log.info("updateConfirmationAtRecruitmentEnded >>> end")
    }
    ...
    fun updateConfirmationAtScreeningEnded() {
        log.info("updateConfirmationAtScreeningEnded>>> start")
        confirmationFacadeService.updateInterviewConfirmWaitingToRejected(12)
        log.info("updateConfirmationAtScreeningEnded >>> end")
    }
    ...
    fun updateConfirmationAtInterviewEnded() {
        log.info("updateConfirmationAtInterviewEnded >>> start")
        confirmationFacadeService.updateFinalConfirmWaitingToRejected(12)
        log.info("updateConfirmationAtInterviewEnded >>> end")
    }
}