...
public class Member extends BaseEntity {
    ...
    private Member(String name, String identification, String rawPassword, PasswordEncoder encoder, Platform platform, Generation generation, Boolean privatePolicyAgreed) {
