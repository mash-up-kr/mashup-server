...
public class DanggnNotificationMemberRecordUpdatedVo extends PushNotiSendVo {
    ...
    public DanggnNotificationMemberRecordUpdatedVo(Long score, Member member, List<Member> members) {
        super(members, String.format(title, member.getName(), new DecimalFormat("###,###").format(score)), body, dataMap);
    }
}
